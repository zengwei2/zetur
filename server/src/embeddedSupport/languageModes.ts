...
export class LanguageModes {
  ...
  // globalSnippetDir: "C:\\Users\\zengwei\\AppData\\Roaming\\Code\\User\\snippets\\vetur"
  async init(env: EnvironmentService, services: VLSServices, globalSnippetDir?: string) {
    // 调用 ../services/vls.ts 中的 dependencyService
  ...
  getModeAtPosition(document: TextDocument, position: Position): LanguageMode | undefined {
    ...
    //  refreshAndGet方法位置：./languageModelCache.ts
    //  getLanguageAtPosition方法位置：./embeddedSupport.ts
