...
// this.lspConnection.onXxx 执行相关命令操作
export class VLS {
  ...
  // params: { capabilities: { window: { xxx }, workspace: { xxx } } // 感觉像是默认的
  //    clientInfo: { name: 'Visual Studio Code', version: '1.90.2' },
  //    processId: xxx,
  //    rootPath: "c:\\Users\\zengwei\\Desktop\\vue\\Vue3\\Vue3-my" // 开发宿主文件夹目录
  //    rootUri: "file:///c%3A/Users/zengwei/Desktop/vue/Vue3/Vue3-my", // 开发宿主文件夹目录
  //    workspaceFolders: [{
  //      uri: "file:///c%3A/Users/zengwei/Desktop/vue/Vue3/Vue3-my",
  //      name: "Vue3-my",
  //     }]
  //  }
  async init(params: InitializeParams) {
    ...
    let rootFsPath = '';
    if (params.rootPath) {
      // 扩展开发宿主的文件夹："c:\\Users\\zengwei\\Desktop\\vue\\Vue3\\Vue3-my"
      rootFsPath = normalizeFileNameToFsPath(params.rootPath);
    } else if (params.rootUri) {
      rootFsPath = getFileFsPath(params.rootUri);
    }
    //  workspaceFolders: [{
    //    fsPath: "file:///c%3A/Users/zengwei/Desktop/vue/Vue3/Vue3-my",
    //    name: "Vue3-my",
    //   }]
  ...
  private async addWorkspace(workspace: { name: string; fsPath: string }) {
    ...
    // "c:\\Users\\zengwei\\Desktop\\vue\\Vue3\\Vue3-my"
  ...
  private setupLSPHandlers() {
    // LSP 对应的各种事件
    // 每输入一个字符，就会触发 onCompletion 事件( LSP example 使用为 snippets 代码提示 )
    this.lspConnection.onCompletion(this.onCompletion.bind(this));
    // 根据 onCompletion return 的规则，则就会触发 onCompletionResolve 的回调函数
    ...
    // 函数签名(就是在写一个函数时 this.fn() 会给一定的提示, 光标在 '()' 中间 )
  ...
  // 鼠标移动上去的提示效果
  // params.textDocument.uri: "file:///c%3A/Users/zengwei/Desktop/vue/Vue3/Vue3-my/index.vue"
  ...
  get capabilities(): ServerCapabilities {
    ...
    return {
      ...
      documentFormattingProvider: false, // 格式化
      hoverProvider: true, // hover 提示
      documentHighlightProvider: true, // 语言高亮
